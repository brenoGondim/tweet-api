...
public class CampaignService implements ICampaignService{
    ...
    public List<CampaignDTO> update(CampaignDTO campaign) {
        ...
        //TODO: tratar quando a campanha for atualizada:
        // busca tweets por data da campanha
        // remove CampanhasUsuarios daquela campanha, iteração e lógica Campanhas x Tweets, atualiza CampanhasUsuarios e o count novamente por usuário
